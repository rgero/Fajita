...
const VisibilityGroup: React.FC<Props> = ({selected, setSelected, disabled = false}) => {
  ...
  return (
    ...
    >
      <ButtonGroup variant="text" size="medium" aria-label="Visibility Button Group" fullWidth disabled={disabled}>
